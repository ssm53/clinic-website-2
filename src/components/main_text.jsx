    ...
    <div className=" flex justify-end">
      <div className="flex flex-col md:flex-row h-full w-[100%] ">
        <div className="flex flex-col justify-center md:w-1/2 pl-[24px] mt-8 md:my-10 mr-10 text-[20px] sm:text-[30px] lg:text-[40px]">
          ...
          >
            <Link href="/services">
              <p className="text-[15px] md:text-[20px] font-normal text-[#5E5E3C] hover:text-[#363630]">
                {props.link1}
              </p>
            </Link>

            <p
              className="text-[15px] md:text-[20px] font-normal text-[#5E5E3C] hover:text-[#363630] cursor-pointer"
